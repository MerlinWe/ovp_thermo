...
interaction_results <- list(
	...
	"mean_BT_smooth ~ phase_mean_CT * season_year" = test_interaction(spring, "mean_BT_smooth", "phase_mean_CT", "season_year", random_effect = ~1 + mean_activity_percent | ID_phase),
	"mean_heartrate ~ phase_mean_CT * season_year" = test_interaction(spring, "mean_heartrate", "phase_mean_CT", "season_year", random_effect = ~1 + mean_activity_percent | ID_phase),
	"mean_activity_percent ~ phase_mean_CT * season_year" = test_interaction(spring, "mean_activity_percent", "phase_mean_CT", "season_year", random_effect = ~1 | ID_phase))

# Get variable descriptives
descriptive_stats <- compute_descriptive_stats(spring, c("mean_BT_smooth", "mean_activity_percent", "mean_heartrate", "phase_mean_CT"))

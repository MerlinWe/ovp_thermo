...
dat_labeled <- as.numeric(rownames(acc_dat)) # Get unlabeled data 
acc_noclass <- acc_all[-dat_labeled, ]
acc_noclass$behaviour <- "unknown"

# Clean Gl.Env.
rm(OVP1_10.3.20, OVP1_17.3.20, OVP1_20.3.20, OVP2_19.3.20,
    OVP4_10.3.20,OVP7_17.3.20 ,OVP7_20.3.20, dat_labeled)
...
df_time_prediction <- calculate_feature_time(df_raw = acc_new, winlen_dba = 10)
...
acc_new$behaviour <- predicted_behaviours
